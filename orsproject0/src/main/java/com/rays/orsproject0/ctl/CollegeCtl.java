...
public class CollegeCtl extends BaseCtl {
	...
	public String submit(@ModelAttribute("form") CollegeForm form, BindingResult bindingResult, Model model,@RequestParam(required = false) String operation, Locale locale) {
