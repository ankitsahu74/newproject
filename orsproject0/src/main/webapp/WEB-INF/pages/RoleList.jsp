					...
					<div class="row p-2 d-flex justify-content-center">
						 ...
						 <div class="col-lg-2">
							<sf:select path="id" class="form-control border-left-right">
								<sf:option value="0">
									<s:message code="label.enterrname" />
								</sf:option>
								
								<sf:options items="${list}" itemValue="id"
									itemLabel="roleName" />
							    </sf:select>
						</div> 
							...
							<table
								...
								<tr>
									<td class="text-center">
										<input class="case" name="chk_1" type="checkbox" value="${role.id}">
									</td>
									<td class="text-center">
									...
									<td class="text-center">
										<c:url var="editUrl" value="/ctl/Role/Role?id=" />
              							<a class="btn btn-outline-warning btn-block btn-round w-100" href="${editUrl}${role.id}">
			...
			<sf:form method="post" modelAttribute="form">
				...
				<c:if test="${!empty list}">
					<div class="row p-2 d-flex justify-content-center">
						...
						<div class="col-lg-3">
							<sf:input path="roleName" cssClass="form-control border-left-right"
