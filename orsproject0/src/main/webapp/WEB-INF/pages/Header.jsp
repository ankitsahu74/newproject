...
<div class="container-fluid">
	...
	<img class="im1" src='<c:url value="http://localhost:8080/orsproject0/resources/main_logo.png">
	</c:url>'>
	</a>
		
		
	
	<a class="text-dark bg-secondary circle p-1 m-0" href='<c:url value="?lang=en"></c:url>'><strong>English</strong></a> 
