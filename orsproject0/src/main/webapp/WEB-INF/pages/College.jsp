	...
	<div class="col-md-5">
		...
		<div class="card c1">
			...
			<div class="card-body c1">
				...
				<s:message code="label.addcollege" />
					...
					<div class="input-group">
						...
						<div class="input-group-prepend">
							...
							<span class="input-group-text">
							 ...
							 <span class="fas fa-university  grey-text"></span>
					...
					<div class="input-group">
						...
						<div class="input-group-prepend">
							<span class="input-group-text">
							 ...
							 <span class="fa fa-address-book grey-text"></span>
							 
							</span>
							
						</div>
						
						<sf:input path="address" class="form-control" placeholder="${enterAddress}" />
