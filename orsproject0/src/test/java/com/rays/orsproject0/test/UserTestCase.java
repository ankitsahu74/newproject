...
public class UserTestCase {
	...
	public void Testadd() {
		...
		dto.setConfirmPassword("ayush@123");
		dto.setPassword("ayush@123");
		dto.setFirstName("Ayush");
		dto.setLastName("parmar");
		dto.setLogin("ayushparmar1230@gmail.com");
		dto.setCreatedBy("ayush");
		dto.setMobileNo("7999917691");
		dto.setModifiedBy("ayush");
